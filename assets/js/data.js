// Données générées : consignes, codes, tests et sorties des 36 épreuves.
const DATA = {
  "quests": {
    "1": {
      "title": "Afficher avec z01.PrintRune",
      "intro": "Premiers programmes et fonctions d'affichage. Tout passe par z01.PrintRune : une rune à la fois. Les runes se comparent et s'incrémentent comme des nombres ('a' = 97)."
    },
    "2": {
      "title": "Chaînes et runes",
      "intro": "Manipuler des string : conversion en []rune, parcours avec range, tests sur les codes ASCII, construction d'une nouvelle chaîne."
    },
    "3": {
      "title": "Maths : itératif et récursif",
      "intro": "Factorielle, puissance, Fibonacci et nombres premiers. Savoir écrire la même logique avec une boucle for, puis sans for grâce à la récursion."
    },
    "4": {
      "title": "Slices et découpage",
      "intro": "Créer et remplir des slices (append ou make), assembler et découper des chaînes."
    }
  },
  "exercises": [
    {
      ...
      "quest": 1,
      "kind": "Programme",
      "file": "quête 1/printalphabet/main.go",
      "sig": "package main — func main()",
      "consigne": "Écrire un programme qui affiche l'alphabet latin en minuscules sur une seule ligne. Une ligne est une suite de caractères suivie du caractère de fin de ligne ('\\n').",
      "bref": "Le programme appelle z01.PrintRune 26 fois, une fois par lettre de 'a' à 'z', puis affiche '\\n' pour terminer la ligne. Aucune boucle : chaque lettre est écrite à la main.",
      "tools": [
        "package main",
        "z01.PrintRune",
        "'\\n'"
      ...
      "lines": [
        [
          1,
          1,
          "package main : c'est un programme exécutable (go run .), pas une fonction de bibliothèque."
        ],
        [
          3,
          3,
          "Seul import autorisé : la bibliothèque z01 qui fournit PrintRune."
        ],
        [
          6,
          31,
          "Une lettre par appel, dans l'ordre alphabétique."
        ],
        [
          32,
          32,
          "Retour à la ligne obligatoire en fin d'affichage."
        ]
      ],
      "run": "go run .",
    ...
    {
      "id": "printreversealphabet",
      "quest": 1,
      "kind": "Programme",
      "file": "quête 1/printreversealphabet/main.go",
      "sig": "package main — func main()",
      "consigne": "Écrire un programme qui affiche l'alphabet latin en minuscules à l'envers (de 'z' à 'a') sur une seule ligne. Une ligne est une suite de caractères suivie de '\\n'. Attention : le cast (conversion de type) est interdit pour cet exercice !",
      "bref": "On part du code ASCII 122 ('z') et on descend jusqu'à 97 ('a') avec une boucle for. À chaque tour, le nombre est converti en rune puis affiché.",
      "tools": [
        "for condition",
        "i--",
        "ASCII 97–122"
      ...
      "lines": [
        [
          6,
          6,
          "i démarre à 122, le code ASCII de 'z'."
        ],
        [
          7,
          7,
          "Boucle « tant que » : on continue tant que i ≥ 97 ('a')."
        ],
        [
          8,
          8,
          "rune(i) transforme le nombre en caractère pour PrintRune."
        ],
        [
          9,
          9,
      ...
      "note": "La consigne interdit le cast, or rune(i) est un cast. Si le jury le remarque : en déclarant directement i := 'z' (une rune), la boucle fonctionne sans aucune conversion.",
      "run": "go run .",
    ...
    },
    {
      ...
      "quest": 1,
      "kind": "Programme",
      "file": "quête 1/printdigits/main.go",
      "sig": "package main — func main()",
      "consigne": "Écrire un programme qui affiche les chiffres décimaux dans l'ordre croissant (de 0 à 9) sur une seule ligne. Une ligne est une suite de caractères suivie de '\\n'.",
      "bref": "Même principe que printreversealphabet, mais en montant : de 48 (code de '0') à 57 (code de '9'), chaque code est converti en rune et affiché.",
      "tools": [
        "for condition",
        "i++",
        "ASCII 48–57"
      ...
      "lines": [
        ...
        [
          7,
          7,
          "On s'arrête après 57, le caractère '9'."
        ],
        [
          8,
          9,
          "Affichage du caractère puis passage au suivant."
        ],
        [
          11,
          11,
    ...
    },
    {
      ...
      "kind": "Fonction",
      "file": "isnegative.go",
      "sig": "func IsNegative(nb int)",
      "consigne": "Écrire une fonction qui affiche 'T' (true) sur une ligne si l'entier passé en paramètre est négatif, sinon elle affiche 'F' (false).",
      "bref": "Un simple if/else : strictement inférieur à 0 → 'T', sinon (0 compris) → 'F'. Le '\\n' est affiché dans tous les cas, après le if.",
      "tools": [
        "package piscine",
        "if / else",
        "z01.PrintRune"
      ...
      "lines": [
        [
          1,
          1,
          "package piscine : c'est une fonction, testée depuis un main séparé."
        ],
        [
          6,
          10,
          "nb < 0 strict : 0 n'est pas négatif et affiche donc 'F'."
        ],
        [
          11,
          11,
          "Le retour à la ligne est hors du if pour ne l'écrire qu'une fois."
        ]
      ],
      "code": "package piscine\n\nimport \"github.com/01-edu/z01\"\n\nfunc IsNegative(nb int) {\n\tif nb < 0 {\n\t\tz01.PrintRune('T')\n\t} else {\n\t\tz01.PrintRune('F')\n\t}\n\tz01.PrintRune('\\n')\n}\n",
    ...
    },
    {
      ...
      "file": "printcomb.go",
      "sig": "func PrintComb()",
      "consigne": "Écrire une fonction qui affiche, dans l'ordre croissant et sur une seule ligne, toutes les combinaisons uniques de trois chiffres différents telles que le premier chiffre soit inférieur au deuxième, et le deuxième inférieur au troisième. Les combinaisons sont séparées par une virgule et un espace.",
      "bref": "Trois boucles imbriquées parcourent tous les triplets de '0' à '9'. On n'affiche que ceux où i < j < k. Après chaque combinaison on écrit \", \", sauf après la dernière : 789.",
      "tools": [
      ...
      "lines": [
        [
          6,
          8,
          "Les compteurs sont directement des runes : pas besoin de conversion pour les afficher."
        ],
        [
          9,
          9,
          "Filtre : ne garde que les chiffres strictement croissants (012, 013…)."
        ],
        [
          10,
          12,
          "Affiche les trois chiffres de la combinaison."
        ],
        [
          13,
          16,
          "Tant que ce n'est pas 789 (la dernière combinaison), on ajoute \", \"."
        ],
        [
          21,
          21,
          "Fin de ligne après toutes les combinaisons."
        ]
      ],
      "outputNote": "Sortie complète sur une seule ligne (120 combinaisons).",
      "code": "package piscine\n\nimport \"github.com/01-edu/z01\"\n\nfunc PrintComb() {\n\tfor i := '0'; i <= '9'; i++ {\n\t\tfor j := '0'; j <= '9'; j++ {\n\t\t\tfor k := '0'; k <= '9'; k++ {\n\t\t\t\tif i < j && j < k {\n\t\t\t\t\tz01.PrintRune(i)\n\t\t\t\t\tz01.PrintRune(j)\n\t\t\t\t\tz01.PrintRune(k)\n\t\t\t\t\tif i != '7' || j != '8' || k != '9' {\n\t\t\t\t\t\tz01.PrintRune(',')\n\t\t\t\t\t\tz01.PrintRune(' ')\n\t\t\t\t\t}\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t}\n\tz01.PrintRune('\\n')\n}\n",
      "test": "package main\n\nimport \"piscine\"\n\nfunc main() {\n\tpiscine.PrintComb()\n}\n",
    ...
    },
    {
      ...
      "file": "printcomb2.go",
      "sig": "func PrintComb2()",
      "consigne": "Écrire une fonction qui affiche, dans l'ordre croissant et sur une seule ligne, toutes les combinaisons possibles de deux nombres différents à deux chiffres. Les combinaisons sont séparées par une virgule et un espace.",
      "bref": "Quatre boucles : i et j forment le premier nombre (ij), k et l le second (kl). On affiche seulement si ij < kl, c'est-à-dire soit la dizaine i < k, soit même dizaine et j < l. La dernière combinaison, 98 99, n'a pas de séparateur.",
      "tools": [
      ...
      "lines": [
        [
          6,
          9,
          "i,j = chiffres du 1er nombre ; k,l = chiffres du 2e nombre."
        ],
        [
          10,
          10,
          "Premier nombre < deuxième : dizaine plus petite (i < k) OU même dizaine et unité plus petite (i == k && j < l). En Go, && est prioritaire sur ||."
        ],
        [
          11,
          15,
          "Affiche « ij kl » avec un espace entre les deux nombres."
        ],
        [
          16,
          19,
          "Ajoute \", \" sauf après « 98 99 », la dernière combinaison."
        ],
        [
          25,
          25,
    ...
    },
    {
      ...
      "kind": "Fonction",
      "file": "firstrune.go",
      "sig": "func FirstRune(s string) rune",
      "consigne": "Écrire une fonction qui renvoie la première rune d'une chaîne de caractères.",
      "bref": "La chaîne est convertie en []rune pour gérer correctement les caractères multi-octets, puis on renvoie l'élément d'indice 0.",
      "tools": [
        "[]rune(s)",
        "r[0]"
      ],
      "lines": [
        [
          4,
          4,
          "Conversion en slice de runes : chaque case = un caractère."
        ],
        [
          5,
          5,
    ...
    },
    {
      ...
      "kind": "Fonction",
      "file": "lastrune.go",
      "sig": "func LastRune(s string) rune",
      "consigne": "Écrire une fonction qui renvoie la dernière rune d'une chaîne de caractères.",
      "bref": "Même principe que FirstRune, mais on prend l'indice len(r)-1 : le dernier élément du slice.",
      "tools": [
        "[]rune(s)",
        "len(r)-1"
      ],
      "lines": [
        ...
        [
          5,
          5,
          "Le dernier indice vaut toujours longueur − 1."
        ]
      ],
    ...
    },
    {
      ...
      "kind": "Fonction",
      "file": "nrune.go",
      "sig": "func NRune(s string, n int) rune",
      "consigne": "Écrire une fonction qui renvoie la n-ième rune d'une chaîne. Si ce n'est pas possible, elle renvoie 0.",
      "bref": "n compte à partir de 1 (1 = premier caractère). On vérifie d'abord que n est dans les bornes, sinon on renvoie 0. Sinon on renvoie r[n-1].",
      "tools": [
        "vérif. des bornes",
        "[]rune(s)",
        "r[n-1]"
      ...
      "lines": [
        [
          4,
          6,
          "Cas impossibles : n inférieur à 1 ou plus grand que la chaîne → 0."
        ],
        [
          7,
          7,
        ...
        [
          9,
          9,
          "Décalage de 1 car n commence à 1 alors que les indices commencent à 0."
        ]
      ],
      "note": "len(s) compte des octets, pas des caractères : avec des accents, n peut passer le test puis dépasser le slice. Comparer à len(r) après la conversion serait plus sûr.",
      "outputNote": "Pour -1 et 5, NRune renvoie 0 : PrintRune(0) écrit un caractère nul invisible, d'où « la!» à l'écran.",
    ...
    },
    {
      ...
      "kind": "Fonction",
      "file": "compare.go",
      "sig": "func Compare(a, b string) int",
      "consigne": "Écrire une fonction qui se comporte comme la fonction Compare de Go (strings.Compare) : 0 si a == b, -1 si a < b, 1 si a > b.",
      "bref": "Go sait comparer deux string directement avec == et > (ordre lexicographique, caractère par caractère). Il suffit de traduire le résultat en 0, 1 ou -1.",
      "tools": [
        "==  >  <",
        "else if"
      ],
      "lines": [
        [
          4,
          5,
          "Chaînes identiques → 0."
        ],
        [
          6,
          7,
          "a après b dans l'ordre lexicographique → 1."
        ],
        [
          8,
          10,
          "Sinon a est avant b → -1."
        ]
      ],
    ...
    },
    {
      ...
      "kind": "Fonction",
      "file": "alphacount.go",
      "sig": "func AlphaCount(s string) int",
      "consigne": "Écrire une fonction qui compte le nombre de lettres d'une chaîne et renvoie ce nombre. Seules les lettres de l'alphabet latin (a–z et A–Z) comptent. Tous les autres caractères (chiffres, symboles, espaces…) sont ignorés.",
      "bref": "On parcourt chaque rune et on incrémente un compteur quand son code est dans 65–90 (majuscules) ou 97–122 (minuscules).",
      "tools": [
        "for range",
        "compteur",
        "65–90 / 97–122"
      ...
      "lines": [
        [
          4,
          5,
          "Conversion en runes et compteur initialisé à 0."
        ],
        [
          7,
          7,
          "Majuscule (65–90) OU minuscule (97–122). && est évalué avant ||."
        ],
        [
          8,
          8,
      ...
      "test": "package main\n\nimport (\n\t\"fmt\"\n\t\"piscine\"\n)\n\nfunc main() {\n\ts := \"Hello 78 World!    4455 /\"\n\tfmt.Println(piscine.AlphaCount(s))\n}\n",
      "output": "10"
    },
    {
      "id": "index",
      ...
      "kind": "Fonction",
      "file": "index.go",
      "sig": "func Index(s string, toFind string) int",
      "consigne": "Écrire une fonction qui se comporte comme la fonction Index (strings.Index) : elle renvoie la position de la première occurrence de toFind dans s, ou -1 si elle est absente.",
      "bref": "Pour chaque position i où le caractère correspond à la première lettre de toFind, on compare les lettres suivantes une à une. Si toutes correspondent, on renvoie i. Sinon, après la boucle, on renvoie -1.",
      "tools": [
        "2 boucles",
      ...
      "lines": [
        [
          4,
          6,
          "Chaîne vide ou recherche vide → 0."
        ],
        [
          7,
          8,
          "Les deux chaînes sont converties en runes."
        ],
        [
          10,
          11,
          "Candidat : le caractère courant est égal à la 1re lettre cherchée."
        ],
        [
          13,
          17,
          "Compte combien des lettres suivantes correspondent."
        ],
        [
          18,
          20,
          "Toutes les lettres restantes correspondent → position trouvée."
        ],
        [
          24,
          24,
          "Aucune correspondance complète."
        ]
      ],
      "note": "Si le début du mot est trouvé tout près de la fin de s (ex. Index(\"Hello\", \"loX\")), rs[i+k] sort du slice et le programme plante : la condition de la ligne 11 devrait être len(rs)-i >= len(rt). Autre écart : Index(\"\", \"a\") renvoie 0 au lieu de -1.",
    ...
    },
    {
      ...
      "kind": "Fonction",
      "file": "concat.go",
      "sig": "func Concat(str1 string, str2 string) string",
      "consigne": "Écrire une fonction qui renvoie la concaténation des deux chaînes passées en arguments.",
      "bref": "En Go, l'opérateur + colle deux string. Une seule ligne suffit.",
      "tools": [
        "str1 + str2"
      ],
      "lines": [
        [
          4,
          4,
          "+ entre deux string crée une nouvelle chaîne."
        ]
      ],
    ...
    },
    {
      ...
      "kind": "Fonction",
      "file": "isupper.go",
      "sig": "func IsUpper(s string) bool",
      "consigne": "Écrire une fonction qui renvoie true si la chaîne passée en paramètre ne contient que des majuscules, sinon elle renvoie false.",
      "bref": "Modèle « chercher l'intrus » : dès qu'un caractère n'est pas entre 65 et 90, on renvoie false. Si la boucle se termine, tout est majuscule → true.",
      "tools": [
        "return anticipé",
        "65–90"
      ],
      "lines": [
        ...
        [
          6,
          8,
          "Hors de 'A'..'Z' → la réponse est forcément false, on sort tout de suite."
        ],
        [
          10,
          10,
    ...
    },
    {
      ...
      "kind": "Fonction",
      "file": "islower.go",
      "sig": "func IsLower(s string) bool",
      "consigne": "Écrire une fonction qui renvoie true si la chaîne passée en paramètre ne contient que des minuscules, sinon elle renvoie false.",
      "bref": "Exactement IsUpper avec la plage 97–122 ('a'..'z').",
      "tools": [
        "return anticipé",
        "97–122"
      ],
      "lines": [
        [
          6,
          8,
          "Hors de 'a'..'z' → false immédiatement."
        ],
        [
          10,
          10,
          "Tous les caractères sont des minuscules."
        ]
      ],
    ...
    },
    {
      ...
      "kind": "Fonction",
      "file": "isalpha.go",
      "sig": "func IsAlpha(s string) bool",
      "consigne": "Écrire une fonction qui renvoie true si la chaîne passée en paramètre ne contient que des caractères alphanumériques (lettres et chiffres) ou si elle est vide, et false sinon.",
      "bref": "Même modèle « chercher l'intrus » : la condition de la ligne 6 doit repérer tout caractère qui n'est ni chiffre, ni majuscule, ni minuscule. Si la boucle finit, on renvoie true (la chaîne vide donne donc true).",
      "tools": [
        "return anticipé",
        "48–57 / 65–90 / 97–122"
      ],
      "lines": [
        ...
        [
          6,
          8,
          "Détection d'un caractère non alphanumérique → false."
        ],
        [
          10,
          10,
          "Chaîne entièrement valide, ou vide."
        ]
      ],
      "note": "En pratique la condition de la ligne 6 ne rejette que ce qui est < 48 ou > 122 : des symboles comme : ; @ [ _ sont acceptés (IsAlpha(\"a[b@c\") donne true). Les tests du sujet passent parce qu'ils contiennent des espaces, ! ou ?. Version logique : if !(chiffre || majuscule || minuscule) { return false }.",
    ...
    },
    {
      ...
      "kind": "Fonction",
      "file": "isnumeric.go",
      "sig": "func IsNumeric(s string) bool",
      "consigne": "Écrire une fonction qui renvoie true si la chaîne passée en paramètre ne contient que des chiffres, sinon elle renvoie false.",
      "bref": "Modèle « chercher l'intrus » avec la plage 48–57 ('0'..'9').",
      "tools": [
        "return anticipé",
        "48–57"
      ],
      "lines": [
        [
          6,
          8,
          "Tout caractère hors de '0'..'9' → false."
        ],
        [
          10,
          10,
    ...
    },
    {
      ...
      "kind": "Fonction",
      "file": "isprintable.go",
      "sig": "func IsPrintable(s string) bool",
      "consigne": "Écrire une fonction qui renvoie true si la chaîne passée en paramètre ne contient que des caractères imprimables, sinon elle renvoie false.",
      "bref": "Les caractères de contrôle (\\n, \\t…) ont un code inférieur à 32. On rejette tout ce qui est hors de la plage imprimable.",
      "tools": [
        "return anticipé",
        "32–126"
      ],
      "lines": [
        [
          6,
          8,
          "Sous 32 = caractère de contrôle → false."
        ],
        [
          10,
          10,
      ...
      "note": "Le code 127 (DEL) n'est pas imprimable mais passe le test r[i] > 127. La borne exacte est r[i] > 126.",
    ...
    },
    {
      ...
      "kind": "Fonction",
      "file": "toupper.go",
      "sig": "func ToUpper(s string) string",
      "consigne": "Écrire une fonction qui met en majuscule chaque lettre d'une chaîne.",
      "bref": "Pour chaque minuscule (97–122), on retire 32 : c'est l'écart entre 'a' (97) et 'A' (65). Les autres caractères ne changent pas. On reconvertit le []rune en string.",
      "tools": [
        "[]rune modifiable",
        "−32",
        "string(r)"
      ...
      "lines": [
        [
          4,
          4,
          "Une string n'est pas modifiable : on passe par []rune."
        ],
        [
          6,
          10,
          "Minuscule → majuscule en soustrayant 32."
        ],
        [
          11,
          12,
    ...
    },
    {
      ...
      "kind": "Fonction",
      "file": "tolower.go",
      "sig": "func ToLower(s string) string",
      "consigne": "Écrire une fonction qui met en minuscule chaque lettre d'une chaîne.",
      "bref": "L'inverse de ToUpper : chaque majuscule (65–90) reçoit +32.",
      "tools": [
        "[]rune modifiable",
        "+32",
        "string(r)"
      ...
      "lines": [
        [
          4,
          4,
          "Conversion en runes pour pouvoir modifier."
        ],
        [
          6,
          10,
          "Majuscule → minuscule en ajoutant 32."
        ],
        [
          11,
          12,
    ...
    },
    {
      ...
      "quest": 2,
      "kind": "Fonction",
      "file": "printnbrinorder.go",
      "sig": "func PrintNbrInOrder(n int)",
      "consigne": "Écrire une fonction qui affiche les chiffres d'un int passé en paramètre dans l'ordre croissant. Toutes les valeurs possibles d'un int doivent fonctionner, sauf les négatifs. La conversion en int64 est interdite.",
      "bref": "Trois étapes : découper le nombre en chiffres (n%10 puis n/=10), trier ce tableau, puis afficher chaque chiffre en ajoutant '0' pour obtenir le caractère. Le cas 0 est traité à part, car la boucle de découpage ne tourne pas.",
      "tools": [
        "n % 10  /  n /= 10",
        "append",
        "tri à bulles",
      ...
      "lines": [
        [
          6,
          8,
          "0 ne produit aucun chiffre dans Convtotable, on l'affiche directement."
        ],
        [
          9,
          9,
          "Découpe, trie, puis parcourt les chiffres triés."
        ],
        [
          10,
          12,
          "Chiffre → caractère : 3 + '0' = '3'."
        ],
        [
          16,
          25,
          "Convtotable : récupère le dernier chiffre (n%10) et le retire (n/=10) jusqu'à 0."
        ],
        [
          27,
          38,
          "SortTable : échange deux cases tant qu'elles ne sont pas dans l'ordre (tri simple en O(n²))."
        ]
      ],
      "outputNote": "Aucun '\\n' dans la fonction : les trois appels s'affichent collés (123, 0, 123).",
    ...
    },
    {
      ...
      "kind": "Fonction",
      "file": "trimatoi.go",
      "sig": "func TrimAtoi(s string) int",
      "consigne": "Écrire une fonction qui transforme les chiffres contenus dans une chaîne en un int. Si le signe - est rencontré avant tout chiffre, il détermine le signe de l'int renvoyé. La fonction renvoie seulement un int. En cas d'entrée invalide (aucun chiffre), elle renvoie 0. Note : il n'y aura jamais plus d'un signe dans une chaîne pendant les tests.",
      "bref": "Si la chaîne contient au moins un chiffre : on ignore tout ce qui n'est pas un chiffre et on construit le nombre avec x = x*10 + chiffre. Ensuite, on cherche un '-' situé avant le premier chiffre pour mettre le signe à -1.",
      "tools": [
        "x = x*10 + y",
        "continue",
        "break",
      ...
      "lines": [
        [
          4,
          5,
          "x = le nombre construit, si = le signe (1 ou -1)."
        ],
        [
          7,
          7,
          "Numeric vérifie qu'il y a au moins un chiffre, sinon on renvoie 0 (ligne 30)."
        ],
        [
          9,
          11,
          "Les caractères qui ne sont pas des chiffres sont sautés."
        ],
        [
          12,
          15,
          "Valeur du chiffre calculée en comptant de '1' jusqu'à la rune (équivaut à int(i - '0'))."
        ],
        [
          16,
          16,
          "On décale d'un rang et on ajoute le chiffre."
        ],
        [
          18,
          27,
          "Parcourt le début de la chaîne jusqu'au premier chiffre : si on croise '-', le résultat sera négatif."
        ],
        [
          34,
          44,
          "Numeric : true dès qu'un chiffre est trouvé."
        ]
      ],
    ...
    },
    {
      ...
      "consigne": "Écrire une fonction qui met en majuscule la première lettre de chaque mot et en minuscule le reste des lettres. Un mot est une suite de caractères alphanumériques.",
      "bref": "Une lettre commence un mot si le caractère juste avant n'est pas alphanumérique. Au début d'un mot, une minuscule passe en majuscule. Au milieu d'un mot, une majuscule passe en minuscule. Le premier caractère est traité à part.",
      "tools": [
        "regarder r[i-1]",
        "±32",
      ...
      "lines": [
        [
          5,
          7,
          "Le premier caractère commence forcément un mot : minuscule → majuscule."
        ],
        [
          9,
          15,
          "Majuscule précédée d'une lettre ou d'un chiffre = milieu de mot → minuscule."
        ],
        [
          16,
          22,
          "Minuscule précédée d'un séparateur = début de mot → majuscule."
        ],
        [
          29,
          34,
          "Vrai si la rune est un chiffre, une majuscule ou une minuscule."
        ],
        [
          36,
          50,
          "Petites fonctions de test minuscule / majuscule."
        ]
      ],
      "note": "r[0] sur une chaîne vide provoque un panic : Capitalize(\"\") plante.",
      ...
      "output": "Hello! How Are You? How+Are+Things+4you?"
    },
    {
      "id": "iterativefactorial",
      "quest": 3,
      "kind": "Fonction",
      "file": "iterativefactorial.go",
      "sig": "func IterativeFactorial(nb int) int",
      "consigne": "Écrire une fonction itérative qui renvoie la factorielle de l'int passé en paramètre. Les erreurs (valeurs impossibles ou dépassements de capacité) renvoient 0.",
      "bref": "Les valeurs négatives ou trop grandes renvoient 0. Sinon on multiplie x par 1, 2, 3… jusqu'à nb. 0! = 1 fonctionne naturellement car la boucle ne tourne pas.",
      "tools": [
        "for i := 1",
        "x *= i",
        "garde overflow"
      ...
      "lines": [
        ...
        [
          12,
          12,
          "Pour nb = 0, la boucle ne tourne pas et on renvoie 1."
        ]
      ],
      "note": "Sur 64 bits, le plus grand résultat possible est 20!. De 21 à 25, le calcul dépasse et renvoie un nombre faux (IterativeFactorial(21) = -4249290049419214848) au lieu de 0. La bonne borne est nb > 20.",
    ...
    },
    {
      ...
      "quest": 3,
      "kind": "Fonction",
      "file": "recursivefactorial.go",
      "sig": "func RecursiveFactorial(nb int) int",
      "consigne": "Écrire une fonction récursive qui renvoie la factorielle de l'int passé en paramètre. Les erreurs (valeurs impossibles ou dépassements) renvoient 0. for est interdit pour cet exercice.",
      "bref": "La fonction s'appelle elle-même : n! = n × (n−1)!. Le cas de base 0 ou 1 renvoie 1 et arrête la récursion.",
      "tools": [
        "récursion",
        "cas de base",
        "pas de for"
      ...
      "lines": [
        ...
        [
          7,
          9,
          "Cas de base : 0! = 1! = 1. Sans lui, la récursion ne s'arrête jamais."
        ],
        [
          10,
          12,
          "Appel récursif avec nb-1."
        ],
        [
          15,
          15,
          "Jamais atteint, mais Go exige un return en fin de fonction."
        ]
      ],
      "note": "Même limite que la version itérative : la garde devrait être nb > 20.",
    ...
    },
    {
      ...
      "quest": 3,
      "kind": "Fonction",
      "file": "iterativepower.go",
      "sig": "func IterativePower(nb int, power int) int",
      "consigne": "Écrire une fonction itérative qui renvoie nb à la puissance power. Une puissance négative renvoie 0. Les dépassements de capacité n'ont pas à être gérés.",
      "bref": "Puissance négative → 0, puissance 0 → 1. Sinon on multiplie x par nb, power fois.",
      "tools": [
        "for",
        "x *= nb"
      ],
      "lines": [
        [
          4,
          6,
          "Puissance négative interdite → 0."
        ],
        [
          7,
          9,
        ...
        [
          10,
          13,
          "On multiplie power fois par nb."
        ]
      ],
    ...
    },
    {
      ...
      "quest": 3,
      "kind": "Fonction",
      "file": "recursivepower.go",
      "sig": "func RecursivePower(nb int, power int) int",
      "consigne": "Écrire une fonction récursive qui renvoie nb à la puissance power. Une puissance négative renvoie 0. Les dépassements n'ont pas à être gérés. for est interdit pour cet exercice.",
      "bref": "nb^power = nb × nb^(power−1). Le cas de base power == 0 renvoie 1.",
      "tools": [
        "récursion",
        "cas de base power == 0"
      ],
      "lines": [
        ...
        [
          10,
          12,
          "Appel récursif en diminuant la puissance."
        ]
      ],
    ...
    },
    {
      ...
      "kind": "Fonction",
      "file": "fibonacci.go",
      "sig": "func Fibonacci(index int) int",
      "consigne": "Écrire une fonction récursive qui renvoie la valeur située à la position index de la suite de Fibonacci. La première valeur est à l'indice 0. La suite commence ainsi : 0, 1, 1, 2, 3, etc. Un indice négatif renvoie -1. for est interdit pour cet exercice.",
      "bref": "Deux cas de base : F(0) = 0 et F(1) = 1. Au-delà, chaque terme est la somme des deux précédents : F(n) = F(n−2) + F(n−1).",
      "tools": [
        "double récursion",
        "2 cas de base"
      ],
      "lines": [
        ...
        [
          7,
          12,
          "Les deux premières valeurs de la suite."
        ],
        [
          14,
          16,
    ...
    },
    {
      ...
      "kind": "Fonction",
      "file": "isprime.go",
      "sig": "func IsPrime(nb int) bool",
      "consigne": "Écrire une fonction qui renvoie true si l'int passé en paramètre est un nombre premier, sinon false. La fonction doit être optimisée pour éviter les time-outs du testeur. (Seuls les nombres positifs peuvent être premiers ; 1 n'est pas premier.)",
      "bref": "Tout nombre inférieur à 2 n'est pas premier. Ensuite on cherche un diviseur entre 2 et nb−1 : si nb % i == 0, il n'est pas premier.",
      "tools": [
        "nb % i == 0",
        "break"
      ],
      "lines": [
        [
          5,
          7,
          "0, 1 et les négatifs ne sont pas premiers."
        ],
        [
          8,
          15,
          "Recherche d'un diviseur : dès qu'on en trouve un, x = false et on sort."
        ],
        [
          16,
          16,
          "true si aucun diviseur n'a été trouvé."
        ]
      ],
      "note": "La boucle va jusqu'à nb : IsPrime(2147483647) prend environ 1 seconde, ce qui risque un time-out. Il suffit de tester jusqu'à la racine carrée : for i := 2; i*i <= nb; i++.",
    ...
    },
    {
      ...
      "quest": 3,
      "kind": "Fonction",
      "file": "findnextprime.go",
      "sig": "func FindNextPrime(nb int) int",
      "consigne": "Écrire une fonction qui renvoie le premier nombre premier supérieur ou égal à l'int passé en paramètre. La fonction doit être optimisée pour éviter les time-outs du testeur. (Seuls les nombres positifs peuvent être premiers.)",
      "bref": "Tout nombre ≤ 2 donne 2. Sinon on se place sur un nombre impair et on avance de 2 en 2 jusqu'à trouver un premier. Ispe teste la primalité en n'essayant que des diviseurs impairs.",
      "tools": [
        "for infini",
        "pas de 2",
        "fonction utilitaire"
      ...
      "lines": [
        [
          4,
          6,
          "2 est le plus petit premier."
        ],
        [
          7,
          9,
          "Un pair > 2 n'est jamais premier : on passe à l'impair suivant."
        ],
        [
          10,
          15,
          "Boucle infinie : teste nb, sinon nb+2, jusqu'au return."
        ],
        [
          18,
          24,
          "Ispe : élimine < 2 et les pairs."
        ],
        [
          25,
          29,
          "Essaie les diviseurs impairs de 3 à nb/3."
        ]
      ],
    ...
    },
    {
      ...
      "kind": "Fonction",
      "file": "appendrange.go",
      "sig": "func AppendRange(min, max int) []int",
      "consigne": "Écrire une fonction qui prend deux entiers min et max et renvoie un slice d'entiers contenant toutes les valeurs de min (inclus) à max (exclu). Si min est supérieur ou égal à max, la fonction renvoie un slice nil. L'utilisation de make est interdite pour cet exercice.",
      "bref": "On part d'un slice nil. Si l'intervalle est vide, on le renvoie tel quel. Sinon on ajoute min, min+1… avec append, qui agrandit le slice tout seul.",
      "tools": [
        "[]int(nil)",
        "append",
        "pas de make"
      ...
      "lines": [
        [
          4,
          4,
          "Slice nil : c'est aussi la valeur à renvoyer en cas d'erreur."
        ],
        [
          5,
          8,
          "l = nombre de valeurs ; l ≤ 0 signifie min ≥ max."
        ],
        [
          10,
          12,
          "append ajoute chaque valeur à la fin du slice."
        ]
      ],
    ...
    },
    {
      ...
      "kind": "Fonction",
      "file": "makerange.go",
      "sig": "func MakeRange(min, max int) []int",
      "consigne": "Écrire une fonction qui prend un int min et un int max. Elle renvoie un slice d'ints contenant toutes les valeurs entre min et max : min inclus, max exclu. Si min est supérieur ou égal à max, un slice nil est renvoyé. append est interdit pour cet exercice.",
      "bref": "Comme la taille est connue d'avance (max − min), on crée le slice avec make, puis on remplit chaque case par son indice : s[i] = min + i.",
      "tools": [
        "make([]int, l)",
        "s[i] = ...",
        "pas d'append"
      ...
      "lines": [
        [
          4,
          8,
          "Intervalle vide → slice nil."
        ],
        [
          9,
          9,
          "make réserve exactement l cases, initialisées à 0."
        ],
        [
          11,
          13,
    ...
    },
    {
      ...
      "sig": "func ConcatParams(args []string) string",
      "consigne": "Écrire une fonction ConcatParams qui prend un slice de strings et renvoie une seule chaîne formée de tous les éléments, séparés par un retour à la ligne (\\n).",
      "bref": "On colle chaque élément à la chaîne résultat et on ajoute \"\\n\" après chacun, sauf le dernier.",
      "tools": [
        "for i, j := range",
        "s += ",
        "sauf le dernier"
      ...
      "lines": [
        ...
        [
          5,
          6,
          "i = indice, j = l'élément ; on l'ajoute."
        ],
        [
          7,
          9,
          "Séparateur uniquement entre les éléments, pas en fin de chaîne."
        ]
      ],
    ...
    },
    {
      ...
      "sig": "func SplitWhiteSpaces(s string) []string",
      "consigne": "Écrire une fonction qui sépare les mots d'une chaîne et les place dans un slice de strings. Les séparateurs sont les espaces, les tabulations et les retours à la ligne.",
      "bref": "On accumule les caractères dans word. Quand on tombe sur un séparateur et que word n'est pas vide, on ajoute le mot au résultat et on vide word. À la fin, le dernier mot est ajouté.",
      "tools": [
        "mot en cours",
        "append",
        "string(y)"
      ...
      "lines": [
        [
          4,
          5,
          "word = mot en construction, result = les mots trouvés."
        ],
        [
          7,
          8,
          "Caractère normal : on l'ajoute au mot en cours."
        ],
        [
          9,
          12,
          "Séparateur après un mot : on range le mot, puis on repart de zéro. Plusieurs espaces de suite ne créent pas de mot vide."
        ],
        [
          14,
          14,
          "Le dernier mot n'est suivi d'aucun séparateur : on l'ajoute ici."
        ]
      ],
      "note": "'\\n' n'est pas testé comme séparateur (\"a\\nb\" reste un seul mot). La ligne 14 ajoute aussi un mot vide si la chaîne se termine par un espace ou est vide : entourer de if word != \"\".",
    ...
    },
    {
      ...
      "sig": "func PrintWordsTables(a []string)",
      "consigne": "Écrire une fonction qui reçoit un slice de strings et affiche chaque élément sur une ligne séparée.",
      "bref": "Pour chaque mot, on affiche ses caractères un par un avec PrintRune, puis un '\\n'.",
      "tools": [
        "2 boucles",
        "z01.PrintRune",
        "[]rune"
      ...
      "note": "range a[i] donne des indices d'octets, qui sont ensuite utilisés dans runes : avec un accent (« été »), l'indice dépasse et le programme plante. Parcourir directement for _, r := range a[i] évite le problème.",
    ...
    },
    {
      ...
      "kind": "Fonction",
      "file": "split.go",
      "sig": "func Split(s, sep string) []string",
      "consigne": "Écrire une fonction qui reçoit une chaîne s et un séparateur sep, et renvoie le slice de strings obtenu en découpant s selon sep.",
      "bref": "Premier passage : compter les séparateurs pour savoir combien de morceaux créer, puis make le slice. Second passage : accumuler les caractères dans word ; quand s[i:i+len(sep)] == sep, ranger word et sauter le séparateur. Le dernier mot est rangé après la boucle.",
      "tools": [
        "s[i:i+n] == sep",
        "make",
        "2 passages"
      ...
      "lines": [
        [
          4,
          9,
          "On ajoute des espaces en fin de s pour que s[i:i+sublength] ne sorte jamais de la chaîne."
        ],
        [
          10,
          19,
          "1er passage : compte les séparateurs pour connaître la taille du résultat."
        ],
        [
          21,
          23,
          "Slice de la bonne taille, mot courant et indice d'écriture."
        ],
        [
          26,
          39,
          "Séparateur trouvé : si le mot n'est pas vide, on le range, puis on saute le reste du séparateur (i += sublength − 1)."
        ],
        [
          40,
          40,
          "Caractère normal : ajouté au mot courant."
        ],
        [
          43,
          49,
          "Range le dernier mot s'il n'est pas vide."
        ]
      ],
      "note": "La variable len (ligne 11) masque la fonction len() à partir de là, d'où les petites boucles for range pour mesurer word. Si le jury l'interroge, renommer cette variable en count simplifie tout.",
